...
/**
 * This class represents contains an integer variable which can be modified. It
 * is thought for using it in Lists or Maps.
 * @author Miquel Esplà Gomis
 * @version 1.0
 */

public class ModificableInteger{
    /** Double value */
    int value;
     ...
     */
    public ModificableInteger(int value) {
        this.value = value;
    }
